    ...
    >
      ...
      <form onSubmit={handleFormSubmit} className="space-y-6">
        ...
        <motion.button
          ...
          className="w-full bg-[#3e4026] text-white py-4 rounded-lg font-semibold text-lg hover:bg-[#5e6043] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
