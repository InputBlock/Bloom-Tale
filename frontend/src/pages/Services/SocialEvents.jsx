...
export default function SocialEvents() {
    ...
    const categories = [
        ...
        "Anniversaries",
        "Baby showers",
        "Cultural & Community Events [Diwali, Christmas decor, etc]",
        "Social Cause Events [Awareness programs, NGO events]"
    ]
        ...
        <>
            ...
            >
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6">
                    ...
                    <p className="text-gray-600 text-sm">Life's precious moments</p>
                </div>
                            ...
                            <div className="p-8">
                                <div className="flex justify-between items-start mb-6">
                                    <div>
                                        ...
                                        <p className="text-gray-600">Memorable celebrations for every occasion</p>
                                    </div>
                                    <button
                                        onClick={() => setIsExpanded(false)}
