      ...
      <div className="relative w-full max-w-6xl mb-6 sm:mb-8 md:mb-10 mx-auto px-2 sm:px-4">
        ...
        >
          <motion.button
            ...
            className="group relative px-8 py-3.5 sm:px-10 sm:py-4 bg-gradient-to-r from-[#5d6c4e] to-[#6b7c59] text-white rounded-full font-semibold text-sm sm:text-base tracking-wide overflow-hidden cursor-pointer"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="ml-120">
              <h3 className="text-xs sm:text-sm font-semibold uppercase tracking-wider mb-3 ml-sm:mb-4">CONNECT</h3>
