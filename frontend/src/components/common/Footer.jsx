        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a 
                href="#" 
                className="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-white hover:text-[#3e4026] transition-all duration-300"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-[11px] tracking-[0.3em] uppercase text-white/50 mb-6">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-white/50 mt-0.5 flex-shrink-0" />
