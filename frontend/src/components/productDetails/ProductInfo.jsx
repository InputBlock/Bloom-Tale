    ...
    <div className="space-y-4 sm:space-y-5 md:space-y-6 px-4 sm:px-6 md:px-8">
      ...
      {product.same_day_delivery ? (
        <div className="space-y-3 sm:space-y-4 pt-2">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
            <h3 className="text-sm sm:text-base font-semibold text-[#3e4026]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            ...
            <button
              ...
              className={`p-3 sm:p-4 text-left border transition-all rounded-sm active:scale-95 ${
          ...
          {selectedDeliveryType === "fixed" && (
            <select className="w-full border border-gray-300 rounded-sm px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm focus:outline-none focus:border-[#3e4026]">
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 pt-2">
        <button 
          ...
          className="bg-[#3e4026] text-white py-3 sm:py-4 px-3 sm:px-6 text-[11px] sm:text-sm font-semibold hover:bg-[#2d2f1c] active:scale-95 transition-all uppercase tracking-wider flex items-center justify-center gap-1.5 sm:gap-2 disabled:bg-gray-300 disabled:cursor-not-allowed rounded-sm">
        ...
        <button 
          ...
          disabled={!product.stock || product.stock === 0}
          className="bg-white border-2 border-[#3e4026] text-[#3e4026] py-3 sm:py-4 px-3 sm:px-6 text-[11px] sm:text-sm font-semibold hover:bg-[#3e4026] hover:text-white active:scale-95 transition-all uppercase tracking-wider disabled:border-gray-300 disabled:text-gray-300 disabled:cursor-not-allowed disabled:hover:bg-white rounded-sm"
        >
          Buy Now
        </button>
      </div>
